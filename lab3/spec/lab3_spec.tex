...
Windows install of \href{https://sourceforge.net/projects/gtkwave/files/gtkwave-3.3.100-bin-win64/gtkwave-3.3.100-bin-win64.zip/download}{gtkwave}.
Add the Vivado install folder bin, gtkwave and Icarus to the Windows PATH.
Install Cygwin.
