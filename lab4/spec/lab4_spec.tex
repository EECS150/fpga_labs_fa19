...
To simulate your \verb|music_streamer| open up \verb|lab3/src/music_streamer_testbench.v|.
...
Run the test with \ttvar{make sim/music_streamer_testbench.vpd} for VCS or \ttvar{make sim/music_streamer_testbench.fst} for Icarus Verilog.
...
\begin{texexptitled}{Music Streamer Simulation}{}
  \begin{enumerate}[a)]
    \item Save a waveform screenshot demonstrating that a \verb|tone_switch_period| of 0 sent by the ROM results in no oscillation of the \verb|square_wave_out| output.
...
A testbench has been provided in \verb|sim/debouncer_testbench.v|. Run it as usual.
